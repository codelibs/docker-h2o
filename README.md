...
-   [`3.30.0.7`](https://github.com/codelibs/docker-h2o/blob/master/Dockerfile)
...
```console
$ docker build --rm -t codelibs/h2o:3.30.0.7 --build-arg GIT_BRANCH=jenkins-3.30.0.7 --build-arg BUILD_NUMBER=7 .
```
